                ...
                <div class="col-md-6">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control gds-cr" country-data-region-id="gds-cr-one" data-language="it"></select>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Country</label>
                            <div class="col-sm-10">
                                <select class="form-control gds-cr gds-countryflag" country-data-region-id="gds-cr-three" data-language="it"></select>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-md-6">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Country</label>
                            <div class="col-sm-10">
                                <select class="form-control gds-cr" country-data-region-id="gds-cr-two" data-language="it" country-data-default-value="US"></select>
                            </div>
                        </div>
                        <div class="form-group">
